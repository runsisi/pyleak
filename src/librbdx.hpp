...
using Map = std::map<K, V, std::less<K>, boost::fast_pool_allocator<std::pair<const K, V>>>;
using Pool = boost::singleton_pool<boost::fast_pool_allocator_tag, sizeof(Map::value_type)>;
